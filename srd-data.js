window.SRD_LIBRARY = {
  "meta": {
    "title": "Daggerheart SRD 1.0",
    "sourcePages": {
      "adversaries": "74–101",
      "environments": "103–111",
      "encounters": "72"
    },
    "language": "en",
    "note": "Public Game Content per the Darrington Press Community Gaming License, as stated in the supplied SRD."
  },
  "adversaries": [
    {
      "id": "srd-adv-acid-burrower",
      "kind": "adversary",
    ...
    {
      "id": "srd-adv-jagged-knife-bandit",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-jagged-knife-kneebreaker",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-jagged-knife-lackey",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-jagged-knife-lieutenant",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-jagged-knife-shadow",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-jagged-knife-sniper",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-minor-chaos-elemental",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-minor-fire-elemental",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-tangle-bramble-swarm",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-patchwork-zombie-hulk",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    },
    {
      ...
      "features": [
        ...
        },
        {
          "name": "Horrifying",
          "type": "Pasiva",
          "text": "Targets who mark HP from the Zombie’s attacks must also mark a Stress. TIER 2 ADVERSARIES (LEVELS 2-4)",
          "bullets": []
        }
      ],
      "imageDataUrl": "",
    ...
    {
      "id": "srd-adv-apprentice-assassin",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    },
    {
      ...
      "features": [
        ...
        },
        {
          ...
          "type": "Reacción",
          "text": "When the Gorgon takes damage from an attack within Close range, you can spend a Fear to force the attacker to make an Instinct Reaction Roll. On a failure, they begin to turn to stone, marking a HP and starting a Petrifi cation Countdown (4). This countdown ticks down when the Gorgon is attacked. When it triggers, the target must make a death move. If the Gorgon is defeated, all petrification countdowns end.",
          "bullets": []
        },
        {
          "name": "Momentum",
    ...
    {
      "id": "srd-adv-juvenile-flickerfly",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-knight-of-the-realm",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    },
    {
      ...
      "features": [
        ...
        },
        {
          "name": "Warding Sphere",
          "type": "Reacción",
          "text": "When the Wizard takes damage from an attack within Close range, deal 2d6 magic damage to the attacker. This reaction can’t be used again until the Wizard refreshes it with their “Refresh Warding Sphere” action. TIER 3 ADVERSARIES (LEVELS 5-7)",
          "bullets": []
        }
      ],
      "imageDataUrl": "",
    ...
    {
      "id": "srd-adv-greater-earth-elemental",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
      ...
      "features": [
        ...
        },
        {
          "name": "Crushing Blows",
          "type": "Pasiva",
          "text": "When the Elemental makes a successful attack, the target must mark an Armor Slot without receiving its benefi ts (they can still use armor to reduce the damage). If they can’t mark an Armor Slot, they must mark an additional HP.",
          "bullets": []
        },
        {
    ...
    {
      "id": "srd-adv-greater-water-elemental",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-vault-guardian-gaoler",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-vault-guardian-sentinel",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-vault-guardian-turret",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    },
    {
      ...
      "features": [
        ...
        },
        {
          "name": "Momentum",
          "type": "Reacción",
          "text": "When the Dragon makes a successful attack against a PC, you gain a Fear. TIER 4 ADVERSARIES (LEVELS 8-10)",
          "bullets": []
        }
      ],
      "imageDataUrl": "",
    ...
    {
      "id": "srd-adv-fallen-warlord-realm-breaker",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
      ...
      "features": [
        ...
        },
        {
          ...
          "type": "Reacción",
          "text": "When the Realm-Breaker marks their last HP, replace them with the Undefeated Champion and immediately spotlight them. FALLEN WARLORD:",
          "bullets": []
        }
      ],
      "imageDataUrl": "",
    ...
    {
      "id": "srd-adv-fallen-warlord-undefeated-champion",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    },
    {
      ...
      "features": [
        ...
        },
        {
          "name": "God Rays",
          "type": "Acción",
          "text": "Mark a Stress to refl ect a sliver of divinity as a searing beam of light that hits up to twenty targets within Very Far range. Targets must make a Presence Reaction Roll, with disadvantage if they are marked Guilty. Targets who fail take 4d6+12 magic damage. Targets who succeed take half damage.",
          "bullets": []
        },
        {
          "name": "We Are One",
    ...
    {
      "id": "srd-adv-outer-realms-abomination",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
      ...
      "sourcePage": 99,
      "source": "Daggerheart SRD 1.0",
      "srdAttackModifierText": "+2d4"
    },
    {
      "id": "srd-adv-outer-realms-corrupter",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
    ...
    {
      "id": "srd-adv-outer-realms-thrall",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
      ...
      "features": [
        ...
        },
        {
          "name": "Group Attack",
          "type": "Acción",
          "text": "Spend a Fear to choose a target and spotlight all Outer Realm Thralls within Close range of them. Those Minions move into Melee range of the target and make one shared attack roll. On a success, they deal 11 physical damage each. Combine this damage. VOLCANIC DRAGON:",
          "bullets": []
        }
      ],
      "imageDataUrl": "",
    ...
    {
      "id": "srd-adv-volcanic-dragon-obsidian-predator",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
      ...
      "features": [
        ...
        },
        {
          ...
          "type": "Reacción",
          "text": "When the Obsidian Predator marks their last HP, replace them with the Molten Scourge and immediately spotlight them. VOLCANIC DRAGON:",
          "bullets": []
        }
      ],
      "imageDataUrl": "",
    ...
    {
      "id": "srd-adv-volcanic-dragon-molten-scourge",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
      ...
      "features": [
        ...
        },
        {
          ...
          "type": "Reacción",
          "text": "When the Molten Scourge marks their last HP, replace them with the Ashen Tyrant and immediately spotlight them. VOLCANIC DRAGON:",
          "bullets": []
        }
      ],
      "imageDataUrl": "",
    ...
    {
      "id": "srd-adv-volcanic-dragon-ashen-tyrant",
      "kind": "adversary",
      "blockTheme": "bruma-menta",
  ...
  "environments": [
    {
      ...
      "imagePositionY": 50,
      "currentId": null,
      "srdEnvironmentType": "Exploration",
      "sourcePage": 103,
      "source": "Daggerheart SRD 1.0"
    },
    {
      ...
      "imagePositionY": 50,
      "currentId": null,
      "srdEnvironmentType": "Event",
      "sourcePage": 103,
      "source": "Daggerheart SRD 1.0",
      "srdDifficultyText": "Special (see “Relative Strength”)"
    },
    {
    ...
    {
      "id": "srd-env-bustling-marketplace",
      "kind": "environment",
      "blockTheme": "bruma-menta",
      ...
      "imagePositionY": 50,
      "currentId": null,
      "srdEnvironmentType": "Social",
      "sourcePage": 104,
      "source": "Daggerheart SRD 1.0"
    },
    {
      "id": "srd-env-cliffside-ascent",
      "kind": "environment",
      "blockTheme": "bruma-menta",
      ...
      "features": [
        {
          "name": "The Climb",
          "type": "Pasiva",
          "text": "Climbing up the cliffside uses a Progress Countdown (12). It ticks down according to the following criteria when the PCs make an action roll to climb: When the countdown triggers, the party has made it to the top of the cliff. What strange formations are the stones arranged in? What ominous warnings did previous adventurers leave?",
          "bullets": [
      ...
      "imagePositionY": 50,
      "currentId": null,
      "srdEnvironmentType": "Traversal",
      "sourcePage": 104,
      "source": "Daggerheart SRD 1.0"
    },
    {
      "id": "srd-env-local-tavern",
      "kind": "environment",
      "blockTheme": "bruma-menta",
      "title": "Local Tavern",
      "tier": 1,
      ...
      "impulses": [
        "Provide opportunities for adventurers",
        "nurture community"
      ],
      "difficulty": 10,
      "potentialAdversaries": [
      ...
      "features": [
        {
          ...
          "type": "Pasiva",
          "text": "A PC can ask the bartender, staff, or patrons about local events, rumors, and potential work with a Presence Roll. On a success, they can pick two of the below details to learn—or three if they critically succeed. On a failure, they can pick one and mark a Stress as the local carries on about something irrelevant. Who has what kind of information? What gossip do the locals start spreading about the PCs?",
          "bullets": [
    ...
    },
    {
      ...
      "features": [
        ...
        },
        {
          ...
          "type": "Pasiva",
          "text": "A PC who prays to a deity while in the Hallowed Temple can make an Instinct Roll to receive answers. If the god they beseech isn’t welcome in this temple, the roll is made with disadvantage. What does it feel like as you are touched by this vision? What feeling lingers after the images have passed?",
          "bullets": [
    ...
    {
      "id": "srd-env-burning-heart-of-the-woods",
      "kind": "environment",
      "blockTheme": "bruma-menta",
      ...
      "features": [
        ...
        },
        {
          ...
          "type": "Pasiva",
          "text": "PCs who approach the central tree can make a Knowledge Roll to try to identify the magic that consumed this environment. What Fallen cult corrupted these woods? What have they already done with the cursed wood and sap from this tree?",
          "bullets": [
    ...
    },
    {
      ...
      "features": [
        ...
        },
        {
          ...
          "type": "Acción",
          "text": "Consequence Countdown (6). The attacking force deploys siege weapons to try to raze the defenders’ fortifi cations. Activate the countdown when the siege begins (for a protracted siege, make this a long-term countdown instead). When it triggers, the defenders’ fortifi cations have been breached and the attackers flood inside. You gain 2 Fear, then shift to the Pitched Battle environment and spotlight it. What siege weapons are being deployed? Are they magical, mundane, or a mixture of both? What defenses must the characters overcome to storm the castle?",
          "bullets": []
        },
        {
          "name": "Reinforcements!",
    ...
    },
    {
      ...
      "features": [
        ...
        },
        {
          "name": "Reinforcements!",
          "type": "Acción",
          "text": "Summon a Knight of the Realm, a number of Tier 3 Minions equal to the number of PCs, and two adversaries of your choice within Far range of a chosen PC as reinforcements. The Knight of the Realm immediately takes the spotlight. Who are they targeting first? What formation do they take? (LEVELS 8-10)",
          "bullets": []
        }
      ],
      "imageDataUrl": "",
      ...
      "features": [
        {
          ...
          "type": "Pasiva",
          "text": "While in the Imperial Court, a PC has disadvantage on Presence Rolls made to take actions that don’t fit the imperial way of life or support the empire’s dominance. How does the way language is used make even discussing alternative ways of living diffi cult? What obvious benefits for loyalty create friction when you try to discuss alternatives?",
          "bullets": []
        },
        {
          "name": "Rival Vassals",
    ...
    {
      "id": "srd-env-necromancers-ossuary",
      "kind": "environment",
      "blockTheme": "bruma-menta",
